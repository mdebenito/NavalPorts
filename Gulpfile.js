...
gulp.task('clean', function(cb) {
    del([ distPaths.files+'*.html', distPaths.images+'**/*', distPaths.scripts+'*.js', distPaths.styles+'*.css', distPaths.libs+'**/*'], cb);
});
 ...
 */
gulp.task('serve', ['html', 'imagemin', 'css', 'js', 'libs'], function() {
    browserSync.init({
        injectChanges: true,
        logLevel: "info",
